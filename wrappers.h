...
#define DDR_Q3_SYMBOLS \
        ...
        _______,  _______,  _______,                                     _______,                                _______,  TG(3),    _______,    _______,  _______,  _______,  _______
...
#define DDR_Q10_NAV \
        _______,  VI_ESC,   _______,  _______,  _______,  _______,  _______,   _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,            _______, \
        _______,  _______,                                             DDR_NUM_ROW,                                              _______,  _______,  _______,            _______, \
        _______,  _______,  _______,  _______,  _______,  _______,  _______,   _______,  VI_UNDO,  VI_UP,    _______,  _______,  _______,  _______,  TG(4),              _______, \
        _______,  _______,  _______,  _______,  _______,  _______,  _______,   VI_INSERT,VI_LEFT,  VI_DOWN,  VI_RIGHT, _______,  _______,            _______,            _______, \
        _______,            _______,  _______,  VI_DELETE,_______,  _______,   _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,           \
        _______,  _______,  _______,            _______,  _______,  _______,                       _______,            _______,                      _______,  _______,  _______
